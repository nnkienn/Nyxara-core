...
| 2026-09-11 | Sáu *(ca tối, máy Mac)* | — | ~45' (23:31-00:15) | — | — | **≤ ~3h09** *(chưa trừ giờ quán)* | giờ-mốc: **0**. Cả ngày ~45' + ~2h25 + ~45' ≈ **3h55 + giờ quán** → đạt sàn. Tối: tìm ra gốc lỗi VS Code (mở thư mục cha làm gốc → settings bị bỏ qua) · sửa máy chấm CRAG cho Python 3.9 · **2a + 2b `make_grade_node` ✅** (khung điền chỗ trống). T7 12/09 đi làm (một lần) |
