...
| 2026-09-11 | Sáu *(ca sáng)* | 3h00 | 45' (07:06-07:51) | — | — | *(gộp sau ca tối)* | giờ-mốc: ~25'. Drill list↔set↔dict 4/6 + ép chọn 3/6 (đảo dấu `:`), chưa sạch · tự viết lại `merge_pieces` đóng sách 4/5 ca (lòi chunk rỗng khi mẩu đầu dài hơn `size`). **Tối phải thêm 2h15** để đạt sàn 3h |
