...
| 2026-09-18 | Sáu *(ca sáng)* | 1h30 | **~1h05** (06:01-07:05) | — | — | *(gộp cuối ngày)* | giờ-mốc: **~55'** (trừ ~10' vá CLAUDE.md). Buổi đầu chạy **Cách A** thật: trả xong vòng đoán `not` · lòi lỗi **VÀ↔HOẶC** (vá bằng kho 3 văn bản chạy 2 chiều) · guard `not` 1 con · **user viết mã giả tiếng Việt → Claude dịch**, ra `loc_sau` chạy đúng. Đo: **3 lỗi logic · 1 lỗi cú pháp · 0 vòng đỏ do gõ**. Vá 2 luật dạy vào CLAUDE.md §3.6 mục 8 (hỏi rõ ràng) + mục 9 (mỗi mẩu phải có việc làm) |
| 2026-09-18 | Sáu *(slot công ty)* | 1h00 | **~1h00** | — | — | *(gộp cuối ngày)* | Vòng vấn đáp đóng sách ĐẦU TIÊN: **0 ✅ · 2 ⚠️ · 1 ❌**. Lỗ nặng nhất: BM25 **đảo nhãn** (Cặp 15). Mẩu 1 Python `doc_dong` xong — 5 vòng đỏ, **không vòng nào là lỗi logic**. Pitch tiếng Anh 60s lần đầu, đóng sách rơi 3/4 đoạn |
| 2026-09-18 | Sáu *(ca tối, vừa OT về)* | 2h00 | **~50'** (22:07-~22:55) | — | — | *(gộp cuối ngày)* | **Hụt ~1h10 so với slot tối 2h** — buổi bắt đầu 22:07 sau OT, áp §3.9 (không đọc code lạ / không trace code cũ / không bài thiết kế). Drill ép chọn **11/12** (Cặp 15 lật lại đúng chiều, câu 3.9 tenant đúng cả 3 ô). Mẩu 2 `dem_luot`: user ra đúng thuật toán bằng lời nhưng **ruột do Claude gõ** (ngoại lệ mệt/hết giờ, §3.6 mục 9) — **chưa tính là lượt gõ thật**. Debug thật có: user tự tìm + tự sửa lỗi thụt lề |
...
> (1h và 1h27 tính tới 22:01). Nhịp giờ học đo được 03→13/09 ≈ **2.45h/ngày**, y hệt nhịp đo ngày 10/09 (2.47h) → **bản re-plan
> 10/09 chưa đổi được gì trong thực tế**. User đã xem bảng toán tới Tết và **chọn ưu tiên hiểu, chấp nhận trễ**
> (*"thà hiểu còn hơn đua thời gian"*) — quyết định của user, đã ghi, không nhắc lại trong buổi.
>
