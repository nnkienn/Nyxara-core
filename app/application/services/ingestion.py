...
class IngestionService:
    ...
    def ingest_file(self, path: str | Path, *, collection: str, tenant_id: str) -> int:
        ...
        vectors = self._embedder.embed(texts)                 # compute-bound, sync
        self._store.ensure_collection(collection, self._embedder.dim)  # dim from the port
